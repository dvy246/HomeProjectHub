          ...
          <div>
            {isEditing ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <button type="button" onClick={startEditing} className="inline-flex items-center justify-center w-10 h-10 rounded-md text-[var(--fg-muted)] hover:text-[var(--fg)] hover:bg-[var(--bg-muted)] transition-colors print:hidden" aria-label={t('projects.rename_aria') ?? 'Rename project'}>
