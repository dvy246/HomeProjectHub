      ...
      <div className="lg:col-span-7 flex flex-col gap-4">
        <Card>
          ...
          <div className="grid grid-cols-2 gap-2 mb-5">
            <button
              type="button"
              onClick={() => setColumnShape("round")}
              className={`border rounded-lg py-2.5 text-xs font-semibold transition-all active:scale-[0.97] ${columnShape === "round" ? "border-[var(--accent)] bg-[var(--accent)] text-[var(--accent-fg)]" : "border-[var(--border)] text-[var(--fg-secondary)] hover:border-[var(--border-hover)]"}`}
            >
              Round Column
            </button>
            <button
              type="button"
              onClick={() => setColumnShape("square")}
              className={`border rounded-lg py-2.5 text-xs font-semibold transition-all active:scale-[0.97] ${columnShape === "square" ? "border-[var(--accent)] bg-[var(--accent)] text-[var(--accent-fg)]" : "border-[var(--border)] text-[var(--fg-secondary)] hover:border-[var(--border-hover)]"}`}
            >
              Square Column
            </button>
          </div>
        ...
        <Card>
          ...
          <form onSubmit={handleSave} className="flex gap-2 items-end">
            <div className="flex-grow">
              <Input label="Project name" type="text" value={roomName} onChange={(e) => setRoomName(e.target.value)} placeholder="e.g. Porch Columns" />
            </div>
