...
> **Tile Count = (Total Area &times; (1 + Waste Factor)) &divide; Area Per Tile**
...
> Wall Area = (Width &times; Height) - (Door Area + Window Area)

Standard doors subtract 21 sq ft (3&prime; &times; 7&prime;). Windows subtract 15 sq ft each (3&prime; &times; 5&prime; average).

### Backsplash
Measure countertop length and multiply by planned backsplash height (typically 18 inches = 1.5 ft):

> Backsplash Area = Counter Length (ft) &times; 1.5 ft
...
|-----------|--------------|-------------------------------|
| 4&times;4 in | 0.111 sq ft | 900 |
| 6&times;6 in | 0.25 sq ft | 400 |
| 8&times;8 in | 0.444 sq ft | 225 |
| 12&times;12 in | 1.0 sq ft | 100 |
| 12&times;24 in | 2.0 sq ft | 50 |
| 24&times;24 in | 4.0 sq ft | 25 |
...
> Grout Needed (lbs) = (Tile Perimeter &times; Joint Width &times; Tile Thickness &times; 0.5) &divide; Coverage per lb
...
A 5&times;8 bathroom (40 sq ft) in a herringbone pattern wastes 20% = 8 sq ft. That extra material can cost $30-60 on mid-range tile. Always calculate pattern waste before ordering.
...
- [Tile Calculator](/calculators/tile/) — Estimate tile quantities for your specific room
- [Paint Calculator](/calculators/paint/) — Plan your room finishing
