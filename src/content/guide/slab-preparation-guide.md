...
1. **Drainage** — Prevents water from wicking up through the slab
2. **Capillary break** — Stops moisture migration from soil to concrete
3. **Uniform support** — Distributes slab weight evenly across the subgrade
...
- [Concrete Slab Calculator](/calculators/concrete/slab/) — Calculate concrete volume for your slab
- [Concrete Mix Ratio Calculator](/calculators/concrete/mix-ratio/) — Find the right mix for your project
- [Rebar Calculator](/calculators/concrete/rebar/) — Determine rebar quantity and spacing
